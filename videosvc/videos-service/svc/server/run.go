...
import (
	...
	// This Service
	pb "mithril/videosvc"
	"mithril/videosvc/videos-service/handlers"
...
func NewEndpoints(service pb.VideosServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		postvideoEndpoint = svc.MakePostVideoEndpoint(service)
		listvideoEndpoint = svc.MakeListVideoEndpoint(service)
